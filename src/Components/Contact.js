...
const Contact = () => {
  const contact = [
    {
      name: 'Email',
      url: 'mailto: caitlinpsherman@gmail.com',
      svg: (
        <svg
    ...
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/caitlinpsherman/',
      svg: (
        <svg
          className="contact-icon"
          xmlns="http://www.w3.org/2000/svg"
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/CaitlinPSherman',
      svg: (
        <svg
          className="contact-icon"
          xmlns="http://www.w3.org/2000/svg"
    ...
    {
      name: 'Resume',
      url: 'https://docs.google.com/document/d/1f60IysLMYtCfa05pP_ocKoqOZCb4Z40AnE4LmZwBr7A/edit?usp=sharing',
      svg: (
        <svg
          className="contact-icon"
          xmlns="http://www.w3.org/2000/svg"
